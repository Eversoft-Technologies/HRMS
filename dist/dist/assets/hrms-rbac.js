...
(function () {
  ...
  var CODE_CATALOG = [
    ...
    ['Attendance',  [['attendance.view', 'View Attendance'], ['attendance.create', 'Create Attendance Log'],
                     ...
                     ['attendance.approve_wfh', 'Approve / Reject WFH Requests'],
                     ['attendance.approve_offsite', 'Approve / Reject Off-site Check-ins'],
                     ['attendance.manage_arrangement', 'Manage Work Arrangements (onsite / hybrid / remote)']]],
